            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        ...
                        <div class="">
                              <div class="pb-2 pt-4">
                                <input id="email" type="email" class="block w-full p-4 text-lg rounded-sm bg-black @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        ...
                        <div class="">
                            ...
                            <div class="pb-2 pt-4">
                                <input id="password" type="password" class="block w-full p-4 text-lg rounded-sm bg-black @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
